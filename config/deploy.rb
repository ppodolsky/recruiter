...
# role :web, "app.example.com"                          # Your HTTP server, Apache/etc
# role :app, "app.example.com"                # This may be the same as your `Web` server
# migrations unnecessary since we're using mongodb
